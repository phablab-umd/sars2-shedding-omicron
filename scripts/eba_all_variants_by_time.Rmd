...
ggsave(total,filename="../output/fig2_eba_variants_by_time.png",device="png",width=11,height=7.77,units="in")
ggsave(total,filename="../output/tiff/fig2_eba_variants_by_time.tiff",device="tiff",width=11,height=7.77,units="in", dpi=600,compression="lzw")
```
