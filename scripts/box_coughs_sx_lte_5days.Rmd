...
spr_before_raw <- spr_before_raw %>% filter(days_past_onset<6|is.na(days_past_onset))

spr_raw <- read.csv(file = "../working_files/nonpaired_pcr_sx_spr.csv")
spr_raw <- spr_raw %>% filter(days_past_onset<6|is.na(days_past_onset))
...
compare_1 <- list(c("A/O","BA.1"), c("A/O","BA.2"), c("Alpha", "BA.2"))
label_compare_1 = c(3.5,4.5,5.5)

compare_2 <- list(c("Delta","BA.2"), c("A/O","BA.2"), c("Alpha", "BA.2"))
label_compare_2 = c(3.5,4.5,5.5)

compare_3 <- list(c("A/O","BA.1"), c("A/O","BA.2"))
label_compare_3 = c(3.5,4.5)

compare_4 <- list(c("A/O","BA.1"))
label_compare_4 = c(3.5)

compare_5 <- list()
label_compare_5 = c()

compare_6 <- list(c("A/O","BA.1"), c("A/O","BA.2"))
label_compare_6 = c(3.5,4.5)

compare_7 <- list(c("Delta","BA.1"))
label_compare_7 = c(3.5)

compare_8 <- list(c("A/O","Alpha"), c("Alpha","BA.1"))
label_compare_8 = c(3.5,4.5)

compare_9 <- list(c("A/O","Alpha"), c("A/O","BA.2"))
label_compare_9 = c(3.5,4.5)

compare_10 <- list(c("A/O","BA.2"))
label_compare_10 = c(3.5)

compare_11 <- list(c("Delta","BA.2"),c("A/O","BA.1"),
                   c("A/O","BA.2"))
label_compare_11 =  c(3.5,4.5,5.5)

compare_12 <- list()
label_compare_12 = c()

compare_13 <- list(c("A/O","BA.1"))
label_compare_13 = c(3.5)
...
compare_16 <- list(c("A/O","BA.1"), c("A/O","BA.2"),c("Alpha","BA.2"))
label_compare_16 = c(3.5,4.5,5.5)
...
ggsave(individual_symptom,filename="../output/si_fig9b_box_sx_all_lte_5days.png",device="png",width=11,height=7.77,units="in")
```

#symptom scores by variants over time with significant comparison
```{r}
compare_17 <- list(c("A/O","BA.1"), c("A/O","BA.2"), c("Alpha", "BA.2"))
label_compare_17 = c(14.5, 15.7, 17)

compare_18 <- list(c("A/O","BA.1"), c("A/O","BA.2"), c("Alpha", "BA.2"))
label_compare_18 = c(14.5, 15.7, 17)

compare_19 <- list(c("Delta","BA.1"),c("Delta","BA.2"),
                   c("A/O","BA.1"),c("A/O","BA.2"))
label_compare_19 = c(14.5,
                     15.7,
                     17,
                     18.2)

compare_20 <- list(c("A/O","Alpha"))
label_compare_20 = c(15)
...
total <- grid.arrange(cough, blank, symptom,
                      ...
                      heights = c(6,1,9))
total
ggsave(total,filename="../output/si_fig8b_box_comp_sx_lte_5days.png",device="png",dpi=300, width=10,height=11,units="in")
# ggsave(total,filename="../output/si_fig8b_box_comp_sx_lte_5days.tiff",device="tiff",dpi=600, width=10,height=11,units="in")  # was originally in manuscript but got moved to SI
```
