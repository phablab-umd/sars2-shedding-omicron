...
breath_saliva_total_wide2 <- breath_saliva_total_wide2 %>% 
  ...
  mutate(log_saliva_coarse_ratio = log10((saliva_av_quant+1)/(coarse_av_quant+1)),
         log_saliva_fine_ratio = log10((saliva_av_quant+1)/(fine_av_quant+1)),
         log_saliva_total_ratio = log10((saliva_av_quant+1)/(av_quant_total+1)),
         saliva_coarse_ratio =  (saliva_av_quant+1)/(coarse_av_quant+1),
         saliva_fine_ratio = (saliva_av_quant+1)/(fine_av_quant+1),
         saliva_total_ratio = (saliva_av_quant+1)/(av_quant_total+1))
...
ggsave(figure_3,filename="../output/si_fig3_corr_fine_mts_saliva_lte_5days.png",device="png",width=11,height=7.77,units="in")
...
figure_4 <- ggarrange(remove_plot_mts(breath_mts_total_wide2,"Coarse","coarse_log_quant", "Omicron"),
                      ...
                      align = "h")
figure_4
#ggsave(figure_4,filename="../output/extend_figure_1_coarse_mts_saliva.png",device="png",width=11,height=7.77,units="in")
ggsave(figure_4,filename="../output/si_fig4b_corr_coarse_mts_saliva_lte_5days.png",device="png",width=11,height=7.77,units="in")
```
...
# ggsave(total,filename="../output/extra-extend-fig-1b-9b/extend_figure_ct_plot.png",device="png",dpi=300,height=12.3,width=10.54,units="in")
```